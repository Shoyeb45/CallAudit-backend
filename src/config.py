...
class AWSSettings(BaseSettings):
    ...
    aws_secret_access_key: str = Field(default="your_secret_key", env="AWS_SECRET_ACCESS_KEY")
    aws_region:str = Field(default="your_region", env="AWS_REGION")
    aws_s3_bucket_name:str = Field(default="your_bucket_name", env="AWS_S3_BUCKET_NAME")
